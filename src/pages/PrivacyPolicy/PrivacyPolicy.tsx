  ...
  return (
    <div className="privacy-policy">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to StartChats, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to StartChats.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to StartChats, accessible from{" "}
            <a
              href="https://startchats.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://startchats.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: idanhershman@gmail.com</li>
      </ul>
    </div>
  );
};
